...
// Drop-off location
$dropoff_location = ovabrw_get_meta_data( 'dropoff_date', $_GET );
...
<!-- Location fields -->
<?php if ( in_array( $rental_type, [ 'day', 'hour', 'mixed', 'hotel', 'period_time' ] ) ): ?>
	<!-- Pick-up location -->
...
<!-- Quatity -->
<?php if ( $product->show_quantity( 'request' ) ):
	// Get quantity
...
?>
	<div class="rental_item">
		...
		<?php ovabrw_text_input([
			'type'          => 'number',
	        'name'          => $product->get_meta_key('number_vehicle'),
